# -*- coding: utf-8 -*-
"""
Created on Wed Jan  15 12:58:52 2020
...
sgd_pipeline = Pipeline([
        ...
        ('svm2_clf',SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, max_iter=1000))
        ])
...
#K-fold cross validation for all classifiers
print("n grams tfidf-Naive Bayes");
build_confusion_matrix(nb_pipeline_ngram)
print("n grams tfidf-Logistic Regression");
build_confusion_matrix(logR_pipeline_ngram)
print("n grams tfidf-SVM");
build_confusion_matrix(svm_pipeline_ngram)
print("n grams tfidf-SGD");
build_confusion_matrix(sgd_pipeline_ngram)
print("n grams tfidf-Random Forest");
